...
`.trimStart(),
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴇʟᴀɪɴᴀ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://whatsapp.com/channel/0029VazznSC7tkjGVc0pI607', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
